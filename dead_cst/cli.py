...
def _output_text(
    ...
    unreachable: MultiDiGraph[SymbolNode],
    root: Path,
...
def _dead_real(unreachable: MultiDiGraph[SymbolNode]) -> list[SymbolNode]:
...
def _dead_suite_locations(
    graph: MultiDiGraph[SymbolNode], package_paths: Sequence[Path]
