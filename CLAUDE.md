...
- `dead_cst.contrib` — the canonical home for third-party-aware extensions: framework plugins (FastAPI, Flask, Click, Typer, pytest, unittest) and the `UvWorkspaceResolver`.
